...
| Project | Short Description | Adriano's Role | Demonstrated Skills | Case Link | Executive HTML |
|---|---|---|---|---|---|
| Schoolia Training OS | EdTech product case for AI-assisted training delivery and platform operations. | Product Owner, Founder / Product Builder, Functional Architect | Product strategy, EdTech thinking, SaaS structuring, AI workflow design | [Case](./projects/schoolia-training-os.md) | [Executive HTML](./projects/schoolia-training-os.html) |
| WhatsBot AI | Conversational automation case for WhatsApp-centered qualification and service flows. | Product Owner, AI workflow designer, Documentation and implementation lead | Automation design, messaging workflows, integration logic, AI operations | [Case](./projects/whatsbot-ai.md) | `to be confirmed` |
| Codestech Mini API | Lightweight API foundation for modular service and integration experiments. | Product Owner, Functional Architect | API design, backend product thinking, modular architecture | [Case](./projects/codestech-mini-api.md) | `to be confirmed` |
| Codestech Lead API | Central lead intake and routing layer for sites, forms and CRM workflows. | Product Owner, Founder / Product Builder | LeadOps, API thinking, integration design, business process clarity | [Case](./projects/lead-api.md) | `to be confirmed` |
| Codestech Website | Public positioning and conversion layer for Codestech. | Product Owner, Founder / Product Builder | Positioning, digital presence, conversion framing | [Case](./projects/codestech-site.md) | `to be confirmed` |
| Site Integration Project | Website-to-operations integration case for lead, CRM and automation handoff. | Product Owner, Functional Architect | Integrations, process design, implementation planning | [Case](./projects/projeto-integracao-site.md) | `to be confirmed` |
| NewHotel Availability Agent | Hospitality AI case for availability intake and triage. | Product Owner, AI workflow designer | Hospitality workflows, AI use-case framing, service automation | [Case](./projects/newhotel-availability-agent.md) | `to be confirmed` |
| NewHotel Availability Web | Web layer supporting hospitality availability workflows. | Product Owner, Functional Architect | Front-end product framing, hospitality UX logic | [Case](./projects/newhotel-availability-web.md) | `to be confirmed` |
| Dora ROI Builder | Strategic concept for ROI, risk and decision support. | Product Owner, Founder / Product Builder | Strategic analysis, ROI logic, executive framing | [Case](./projects/dora-roi-builder.md) | `to be confirmed` |
| Funding Radar / Portugal 2030 | Monitoring concept for funding notices and opportunity prioritization. | Product Owner, AI workflow designer | Research structure, public-funding logic, monitoring workflows | [Case](./projects/funding-radar-portugal-2030.md) | `to be confirmed` |
